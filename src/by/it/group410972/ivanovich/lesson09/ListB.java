...
public class ListB<E> implements List<E> {
    ...
    private class ListBIterator implements Iterator<E> {
        protected int cursor = 0; // Изменено с private на protected
        protected int lastReturned = -1; // Изменено с private на protected
    ...
    private class ListBListIterator extends ListBIterator implements ListIterator<E> {
        ListBListIterator(int index) {
            super();
            this.cursor = index; // Теперь доступ к cursor разрешен
        }
        ...
        public E previous() {
            ...
            cursor--;
            lastReturned = cursor; // Теперь доступ к lastReturned разрешен
            return (E) elements[cursor];
        }
