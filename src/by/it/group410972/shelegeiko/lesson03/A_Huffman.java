...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        // Очищаем статическую карту перед каждым вызовом
        codes.clear();
        ...
        // Если в строке только один уникальный символ
        ...
        if (!priorityQueue.isEmpty()) {
            ...
            // Если коды еще не сгенерированы (для случая > 1 символа)
            if (codes.isEmpty()) {
                root.fillCodes("");
            }
        }
        ...
        //Кодируем исходную строку с помощью сгенерированных кодов
        for (char c : s.toCharArray()) {
