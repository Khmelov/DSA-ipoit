...
public class ListB<E> implements List<E> {
    ...
    private E[] elements;        // внутренний массив для хранения данных
    private int size = 0;        // текущий размер списка
    private static final int INITIAL_CAPACITY = 10;  // начальная ёмкость
    ...
    // --- Остальные методы интерфейса List оставим не реализованными ---
    @Override
