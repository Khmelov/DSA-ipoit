...
public class B_Huffman {
    ...
    String decode(InputStream inputStream) throws FileNotFoundException {
        ...
        scanner.nextLine(); // перейти на следующую строку после чтения чисел

        //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! НАЧАЛО ЗАДАЧИ !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
        //тут запишите ваше решение

        // Считаем коды букв и сохраним в Map: код -> символ
        ...
        // Считаем закодированную строку
        String encoded = scanner.nextLine();

        // Декодируем: двигаемся по строке и пытаемся найти совпадения с кодами в map
        StringBuilder currentCode = new StringBuilder();
        for (char bit : encoded.toCharArray()) {
            currentCode.append(bit);
            if (codeToChar.containsKey(currentCode.toString())) {
                // нашли символ для текущего кода
